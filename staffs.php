...
<head>
  ...
  <title>Dog Food & Supplies System: Staffs</title>
  <!-- Bootstrap -->
    ...
    <form action="staffs.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
          ...
          <input name="name" type="text" class="form-control" id="staffname" placeholder="Name" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_name']; ?>" required>
           ...
           <div class="form-group">
          <label for="staffgender" class="col-sm-3 control-label"> Staff Gender</label>
          <div class="col-sm-9">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        ...
        $stmt = $conn->prepare("select * from tbl_staffs_a189016_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
